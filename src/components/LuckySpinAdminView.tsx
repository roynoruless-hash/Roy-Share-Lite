          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-4 shadow-xl">
              ...
              {(() => {
                ...
                const joinUrl = `https://t.me/${botUser}?startapp=luckyspin_join_${selectedEvent.id}`;
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => {
                              ...
                              const shareUrl = `https://t.me/share/url?url=${encodeURIComponent(joinUrl)}&text=${encodeURIComponent(text)}`;
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => {
                              ...
                              const shareUrl = `https://t.me/share/url?url=${encodeURIComponent(liveUrl)}&text=${encodeURIComponent(text)}`;
                              window.open(shareUrl, "_blank");
                            }}
                            className="flex-1 sm:flex-initial bg-indigo-650 hover:bg-indigo-600 text-white px-3 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-center gap-1"
                            title="Share Link"
