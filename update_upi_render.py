...
old_header = """  const allowQrUpload = giveaway.entryRules?.allowQrUpload ?? true;
...
new_header = """  const allowQrUpload = giveaway.entryRules?.allowQrUpload ?? true;
...
old_main = """      <main className="p-6 max-w-md mx-auto space-y-6 relative z-10">
        
        {/* Giveaway Main Details Card */}"""

new_main = """      <main className="p-6 max-w-md mx-auto space-y-6 relative z-10">
